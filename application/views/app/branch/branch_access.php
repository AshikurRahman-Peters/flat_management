<div class="content">
    <div class="row ">
        <div class="col-md-6">
            ...
            <?php echo form_open('branchInsert'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="branch_title" class="form-control" >
            </div>
            <div class="form-group">
                <label for="branch_address">Branch Address</label>
                <input type="text" name="branch_address" class="form-control" >
            </div>
            <input type="submit" name="submit" value="Add Branch" class="btn btn-primary">
            <?php echo form_close() ?>
        </div>
    </div>
