<div class="content">
    <div class="row ">
        <div class="col-md-6">
            ...
            <?php echo form_open('userInsert'); ?>
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" name="user_name" class="form-control" placeholder="User name here">
            </div>
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" name="email" class="form-control" placeholder="Email name here">
            </div>
            <div class="form-group">
                <label for="password">password</label>
                <input type="password" name="password" class="form-control" placeholder="Password name here">
            </div>
                ...
                ?>		
					<tr>
						...
						<td class="text-center">
							<a href="<?php echo base_url().'menu_access/'.$value->id; 
                                        ?>" class="btn btn-info">Menu Access</a>
