...
<div class="content" id="app">
    ...
    <?php
    foreach ($get_all_rent_info as $value) {
    ?>

        <div class="table_head mt-2" >
            <div class="text-center">
                ...
                <div class="header_title">
                    <div class="name_owner">
                        <span style="width: 100%;">ফ্ল্যাট মালিক/বাড়াটিয়ার নাম: <span style="border-bottom: 1px dotted;"><?php echo $value->ownar_name; ?></span>
                    </div>
                    <div class="month_flat">
                        <span style="width: 100%;">মাস : <span style="border-bottom: 1px dotted;"><?php echo $value->month_name; ?></span>
                        <span style="width: 40%;">ফ্লাট নং: <span style="border-bottom: 1px dotted;"><?php echo $value->unit_name; ?></span>
                    </div>
                </div>
            </div>
            ...
            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <tr>
                        <th>১</th>
                        <th>বাসাভাড়া</th>
                        <th><?php echo $value->rent_amount; ?></th>
                    </tr>
                    <tr>
                        <th>২</th>
                        <th>গেরেজ ভাড়া</th>
                        <th><?php echo $value->fld_garage; ?></th>
                    </tr>
                    <tr>
                        <th>৩</th>
                        <th>অন্যান্য</th>
