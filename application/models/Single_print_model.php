 ...
 * 
 */
class Single_print_model extends CI_Model
{
    public function __construct()
	{
		$this->branch_id=$this->session->userdata('branch_id');
	}
    public function get_all_billing_info($id)
    {
        $query = $this->db->query("
    	SELECT
    ...
    LEFT JOIN tbl_month_entry on tbl_service_transaction.service_month_id = tbl_month_entry.id
     WHERE 
         tbl_service_transaction.fld_status='a'
         and 
         tbl_service_transaction.id = $id
         and 
         tbl_service_transaction.branch_id = $this->branch_id
    ...
    public function get_all_rent_info($id)
    {
        $query = $this->db->query("
    	SELECT
    ...
    LEFT JOIN tbl_month_entry on tbl_rent_transaction.service_month_id = tbl_month_entry.id
     WHERE 
         tbl_rent_transaction.fld_status='a'
         and 
         tbl_rent_transaction.id = $id
         and 
         tbl_rent_transaction.branch_id = $this->branch_id
